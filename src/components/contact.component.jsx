...
export default function Contact() {
    ...
    return (
        <div id="about" className="contact >> flex flex-col justify-center items-center | w-full p-4 pt-8 pb-8 gap-8 | lg:max-w-7xl lg:snap-center">
            ...
            <div className="contact__container >> flex flex-2/3 justify-center flex-wrap | w-full gap-4 | lg:gap-0 lg:flex-nowrap ">
                {list.map(({ name, list }, index) =>
                    <div className={`contact__card >> flex flex-col md:flex-1/3 | w-full py-4 gap-8 | border-golden-1 bg-white | text-blue-1 ${index === 0 ? "" : "lg:border-l-3"}`} key={name + index}>
