...
export default function JourneyBooking() {
    ...
    return (
        <div className=" journey-booking >> flex flex-col justify-center items-center | p-4 py-8 gap-8 w-full h-fit | md:h-[700px] md:max-w-7xl md:py-16 " >
            ...
            <div className="journey-booking__container-card >> flex justify-center items-center flex-wrap | gap-4 w-full h-fit | md:flex-nowrap | md:h-[500px] md:gap-8">
