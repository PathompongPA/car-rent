...
export default function Promotion() {
    ...
    return (
        <div className="promotion flex flex-col w-full lg:w-7xl text-description-1 font-black text-white bg-blue-2  px-4 py-8">
            ...
            <div className="promotion_container-card *** flex flex-row flex-wrap items-center justify-center py-8 gap-16">
                {prices && prices.map(({ title, price }) =>
                    <div className="promotion__card*** flex flex-col  items-center p-4 gap-2.5" key={title}>
