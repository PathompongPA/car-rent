...
export default function NavbarAdmin() {
    ...
    return (
        <ul className=" fixed flex flex-col  md:col-span-2 gap-4 text-end *:p-4 w-full bg-gray-900 z-50 " >
            ...
            <div className="navbar-admin --- border-gray-800 hidden flex flex-col h-[100vh] top-4 gap-4 *:p-2 *:not-first:hover:text-golden-1 " onClick={() => { document.getElementsByClassName("navbar-admin")[0].classList.toggle("hidden") }}>
